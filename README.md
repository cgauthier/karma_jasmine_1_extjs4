Testing ExtJS 4.x applications using Karma and Jasmine 1.x
----------------------------------------------------------
...
- Installation
- Running Tests for Karma/Jasmine 1.0
- Debugging
- Conclusion
...
I will be assuming you have your app at a root folder of a web server folder such as: htdocs/karma_jasmine_1_extjs4 folder.
...
At the moment of writing this documentation, the default installation of jasmine is version 1.5.
...
module.exports = function(config) {
    config.set({
        ...
        basePath: 'c:/xampp/htdocs/karma_jasmine_1_extjs4',
